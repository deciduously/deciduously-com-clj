...
(defn get-pages
  "Run all the raw pages through and append pre-compiled apps"
  []
  (s/merge-page-sources
   {:internal (prepare-pages (get-raw-pages))
    :external (s/slurp-directory "resources/apps/" #"\.(html|js|css)$")}))
