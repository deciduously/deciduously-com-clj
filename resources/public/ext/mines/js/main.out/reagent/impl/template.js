...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__9342__auto__,writer__9343__auto__,opt__9344__auto__){
return cljs.core._write(writer__9343__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__14732 = o;
(G__14732[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
reagent.impl.template.stringify_class = (function reagent$impl$template$stringify_class(p__14737){
var map__14738 = p__14737;
var map__14738__$1 = ((((!((map__14738 == null)))?((((map__14738.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14738.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14738):map__14738);
var props = map__14738__$1;
var class$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14738__$1,cljs.core.cst$kw$class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__14740){
var map__14741 = p__14740;
var map__14741__$1 = ((((!((map__14741 == null)))?((((map__14741.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__14741.cljs$core$ISeq$)))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__14741):map__14741);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14741__$1,cljs.core.cst$kw$on_DASH_write);
...
return reagent.impl.batching.do_after_render(((function (node_value,map__14741,map__14741__$1,on_write){
return (function (){
...
});})(node_value,map__14741,map__14741__$1,on_write))
);
} else {
...
reagent.impl.template.input_render_setup.cljs$core$IFn$_invoke$arity$3 = (function (this$,jsprops,p__14746){
...
var synthetic_on_update = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14747__$1,cljs.core.cst$kw$synthetic_DASH_on_DASH_update);
var synthetic_on_change = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14747__$1,cljs.core.cst$kw$synthetic_DASH_on_DASH_change);
if(cljs.core.truth_((function (){var and__8659__auto__ = !((jsprops == null));
if(and__8659__auto__){
var and__8659__auto____$1 = jsprops.hasOwnProperty("onChange");
if(cljs.core.truth_(and__8659__auto____$1)){
return jsprops.hasOwnProperty("value");
} else {
return and__8659__auto____$1;
}
} else {
return and__8659__auto__;
}
})())){
...
var G__14749 = jsprops;
(G__14749["defaultValue"] = value);

(G__14749["onChange"] = ((function (G__14749,v,value,on_change,on_change__$1,map__14747,map__14747__$1,synthetic_on_update,synthetic_on_change){
return (function (p1__14743_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change__$1,p1__14743_SHARP_);
});})(G__14749,v,value,on_change,on_change__$1,map__14747,map__14747__$1,synthetic_on_update,synthetic_on_change))
);
...
var vec__14753 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14753,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14753,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14753,(2),null);
...
var jsprops = ({"argv": v});
var temp__5461__auto___14757 = reagent.impl.template.key_from_vec(v);
if((temp__5461__auto___14757 == null)){
} else {
var key_14758 = temp__5461__auto___14757;
(jsprops["key"] = key_14758);
}
...
reagent.impl.template.adapt_react_class.cljs$core$IFn$_invoke$arity$2 = (function (c,p__14761){
...
var synthetic_input = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__14762__$1,cljs.core.cst$kw$synthetic_DASH_input);
...
var wrapped = (function (){var G__14764 = reagent.impl.template.__GT_NativeWrapper();
(G__14764["name"] = c);
...
var wrapped__$1 = (cljs.core.truth_(synthetic_input)?(function (){var G__14765 = wrapped;
(G__14765["syntheticInput"] = true);

return G__14765;
})():wrapped);
var wrapped__$2 = (cljs.core.truth_(synthetic_input)?(function (){var G__14766 = wrapped__$1;
(G__14766["syntheticOnChange"] = on_change);

return G__14766;
})():wrapped__$1);
var wrapped__$3 = (cljs.core.truth_(synthetic_input)?(function (){var G__14767 = wrapped__$2;
(G__14767["syntheticOnUpdate"] = on_update);
...
var len__9950__auto___14774 = arguments.length;
var i__9951__auto___14775 = (0);
while(true){
if((i__9951__auto___14775 < len__9950__auto___14774)){
args__9957__auto__.push((arguments[i__9951__auto___14775]));

var G__14776 = (i__9951__auto___14775 + (1));
i__9951__auto___14775 = G__14776;
continue;
} else {
}
break;
...
var argseq__9958__auto__ = ((((1) < args__9957__auto__.length))?(new cljs.core.IndexedSeq(args__9957__auto__.slice((1)),(0),null)):null);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__9958__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq14772){
var G__14773 = cljs.core.first(seq14772);
var seq14772__$1 = cljs.core.next(seq14772);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__14773,seq14772__$1);
});
...
break;
default:
var G__14779 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__14779;
continue;
...
var n__9716__auto___14781 = a.length;
var i_14782 = (0);
while(true){
if((i_14782 < n__9716__auto___14781)){
(a[i_14782] = reagent.impl.template.as_element((a[i_14782])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__9716__auto___14784 = a.length;
var i_14785 = (0);
while(true){
if((i_14785 < n__9716__auto___14784)){
var val_14786 = (a[i_14785]);
if((cljs.core.vector_QMARK_(val_14786)) && ((reagent.impl.template.key_from_vec(val_14786) == null))){
(o["no-key"] = true);
} else {
}

(a[i_14785] = reagent.impl.template.as_element(val_14786));
...
var ctx = ({});
var vec__14788 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14788,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__14788,(1),null);
...
var G__14791 = (cljs.core.count(argv) - first_child);
switch (G__14791) {
case (0):
...
case (1):
var G__14792 = comp;
var G__14793 = jsprops;
var G__14794 = reagent.impl.template.as_element(cljs.core.nth.cljs$core$IFn$_invoke$arity$3(argv,first_child,null));
return (reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3 ? reagent.impl.template.global$module$react.createElement.cljs$core$IFn$_invoke$arity$3(G__14792,G__14793,G__14794) : reagent.impl.template.global$module$react.createElement.call(null,G__14792,G__14793,G__14794));

break;
default:
return reagent.impl.template.global$module$react.createElement.apply(null,cljs.core.reduce_kv(((function (G__14791){
