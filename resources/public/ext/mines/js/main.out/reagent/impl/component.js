...
if((i < len)){
var k = (ks[i]);
var G__14681 = cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(m,cljs.core.keyword.cljs$core$IFn$_invoke$arity$1(k),(o[k]));
var G__14682 = (i + (1));
m = G__14681;
i = G__14682;
continue;
...
var temp__5459__auto__ = (p["argv"]);
if((temp__5459__auto__ == null)){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,(function (){var G__14683 = (p["children"]);
return (reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$react.Children.toArray.cljs$core$IFn$_invoke$arity$1(G__14683) : reagent.impl.component.global$module$react.Children.toArray.call(null,G__14683));
})());
} else {
var v = temp__5459__auto__;
...
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__14685 = c;
var G__14685__$1 = (((G__14685 == null))?null:G__14685.prototype);
if((G__14685__$1 == null)){
return null;
} else {
return (G__14685__$1["reagentRender"]);
}
})() == null)));
});
reagent.impl.component.react_class_QMARK_ = (function reagent$impl$component$react_class_QMARK_(c){
return (cljs.core.fn_QMARK_(c)) && (!(((function (){var G__14687 = c;
var G__14687__$1 = (((G__14687 == null))?null:G__14687.prototype);
if((G__14687__$1 == null)){
return null;
} else {
return (G__14687__$1["render"]);
}
})() == null)));
});
...
return (function() { 
var G__14691__delegate = function (args){
var G__14689 = cljs.core.apply.cljs$core$IFn$_invoke$arity$3(cljs.core.vector,res,args);
return (reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.as_element.cljs$core$IFn$_invoke$arity$1(G__14689) : reagent.impl.component.as_element.call(null,G__14689));
};
var G__14691 = function (var_args){
var args = null;
...
while (G__14692__i < G__14692__a.length) {G__14692__a[G__14692__i] = arguments[G__14692__i + 0]; ++G__14692__i;}
  args = new cljs.core.IndexedSeq(G__14692__a,0,null);
} 
return G__14691__delegate.call(this,args);};
G__14691.cljs$lang$maxFixedArity = 0;
G__14691.cljs$lang$applyTo = (function (arglist__14693){
var args = cljs.core.seq(arglist__14693);
return G__14691__delegate(args);
});
...
var _STAR_current_component_STAR_14695 = reagent.impl.component._STAR_current_component_STAR_;
...
}finally {reagent.impl.component._STAR_current_component_STAR_ = _STAR_current_component_STAR_14695;
}});
...
return ((function (G__14696,G__14696__$1){
...
var or__8671__auto__ = reagent.impl.util._STAR_always_update_STAR_;
if(or__8671__auto__){
...
var c = this;
var G__14697_14699 = (c["cljsRatom"]);
if((G__14697_14699 == null)){
} else {
reagent.ratom.dispose_BANG_(G__14697_14699);
}
...
if(cljs.core.truth_((function (){var and__8659__auto__ = wrap;
if(cljs.core.truth_(and__8659__auto__)){
return f;
} else {
...
var renders_14701 = cljs.core.select_keys(fmap,new cljs.core.PersistentVector(null, 3, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.cst$kw$render,cljs.core.cst$kw$reagentRender,cljs.core.cst$kw$componentFunction], null));
var render_fun_14702 = cljs.core.first(cljs.core.vals(renders_14701));
if((cljs.core.count(renders_14701) > (0))){
} else {
throw (new Error(["Assert failed: ","Missing reagent-render","\n","(pos? (count renders))"].join('')));
}

if(((1) === cljs.core.count(renders_14701))){
} else {
throw (new Error(["Assert failed: ","Too many render functions supplied","\n","(== 1 (count renders))"].join('')));
}

if(cljs.core.ifn_QMARK_(render_fun_14702)){
} else {
throw (new Error(["Assert failed: ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(["Expected something callable, not ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(cljs.core.pr_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([render_fun_14702], 0)))].join('')),"\n","(clojure.core/ifn? render-fun)"].join('')));
}


var render_fun = (function (){var or__8671__auto__ = cljs.core.cst$kw$reagentRender.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__8671__auto__)){
return or__8671__auto__;
} else {
...
var render_fun__$1 = (function (){var or__8671__auto__ = render_fun;
if(cljs.core.truth_(or__8671__auto__)){
return or__8671__auto__;
} else {
...
var name = [cljs.core.str.cljs$core$IFn$_invoke$arity$1((function (){var or__8671__auto__ = cljs.core.cst$kw$displayName.cljs$core$IFn$_invoke$arity$1(fmap);
if(cljs.core.truth_(or__8671__auto__)){
return or__8671__auto__;
} else {
...
var name__$1 = (function (){var G__14700 = name;
switch (G__14700) {
case "":
...
var G__14705 = reagent.impl.component.cljsify(body);
return (reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.global$module$create_react_class.cljs$core$IFn$_invoke$arity$1(G__14705) : reagent.impl.component.global$module$create_react_class.call(null,G__14705));
});
reagent.impl.component.fiber_component_path = (function reagent$impl$component$fiber_component_path(fiber){
var name = (function (){var G__14706 = fiber;
var G__14706__$1 = (((G__14706 == null))?null:(G__14706["type"]));
if((G__14706__$1 == null)){
return null;
} else {
return (G__14706__$1["displayName"]);
}
})();
var parent = (function (){var G__14707 = fiber;
if((G__14707 == null)){
return null;
} else {
return (G__14707["return"]);
}
})();
var path = (function (){var G__14708 = parent;
var G__14708__$1 = (((G__14708 == null))?null:(reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.fiber_component_path.cljs$core$IFn$_invoke$arity$1(G__14708) : reagent.impl.component.fiber_component_path.call(null,G__14708)));
if((G__14708__$1 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14708__$1)," > "].join('');
}
})();
...
var temp__5455__auto__ = (function (){var G__14709 = c;
if((G__14709 == null)){
return null;
} else {
return (G__14709["_reactInternalFiber"]);
}
})();
...
var elem = (function (){var G__14710 = (function (){var or__8671__auto__ = (function (){var G__14712 = c;
if((G__14712 == null)){
return null;
} else {
return (G__14712["_reactInternalInstance"]);
}
})();
if(cljs.core.truth_(or__8671__auto__)){
return or__8671__auto__;
...
return (G__14710["_currentElement"]);
}
})();
var name = (function (){var G__14713 = elem;
var G__14713__$1 = (((G__14713 == null))?null:(G__14713["type"]));
if((G__14713__$1 == null)){
return null;
} else {
return (G__14713__$1["displayName"]);
}
})();
var path = (function (){var G__14714 = elem;
var G__14714__$1 = (((G__14714 == null))?null:(G__14714["_owner"]));
var G__14714__$2 = (((G__14714__$1 == null))?null:(reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.component.component_path.cljs$core$IFn$_invoke$arity$1(G__14714__$1) : reagent.impl.component.component_path.call(null,G__14714__$1)));
if((G__14714__$2 == null)){
return null;
} else {
return [cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__14714__$2)," > "].join('');
}
})();
var res = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(path),cljs.core.str.cljs$core$IFn$_invoke$arity$1(name)].join('');
if(cljs.core.empty_QMARK_(res)){
...
var n = (function (){var or__8671__auto__ = reagent.impl.component.component_path(c);
if(cljs.core.truth_(or__8671__auto__)){
return or__8671__auto__;
} else {
var G__14715 = c;
var G__14715__$1 = (((G__14715 == null))?null:G__14715.constructor);
if((G__14715__$1 == null)){
return null;
} else {
return reagent.impl.util.fun_name(G__14715__$1);
}
}
})();
